        ...
        DRINKS = BUILDER
                .defineList("drinks", Arrays.asList
                                (
                                        ...
                                        Arrays.asList("toughasnails:leather_dirty_water_bottle", 6, 8),
                                        Arrays.asList("toughasnails:leather_purified_water_bottle", 8, 10),
                                        ...
                                        Arrays.asList("toughasnails:iron_dirty_water_bottle", 6, 8),
                                        Arrays.asList("toughasnails:iron_purified_water_bottle", 8, 10),
                                        ...
                                        Arrays.asList("toughasnails:gold_dirty_water_bottle", 6, 8),
                                        Arrays.asList("toughasnails:gold_purified_water_bottle", 8, 10),
                                        ...
                                        Arrays.asList("toughasnails:netherite_dirty_water_bottle", 6, 8),
                                        Arrays.asList("toughasnails:netherite_purified_water_bottle", 8, 10),
